...
public interface HBaseRowDataConverter<RESULT> extends Serializable {

    RESULT convert(byte[] rowKey, byte[] family, byte[] qualifier, byte[] value) throws Exception;


    HBaseRowDataConverter<HBaseRowData<String, String, String, String>> SIMPLE_COLUMN_CONVERTER =
